...
RESPONSES_API_PROXY_NPM_ROOT = REPO_ROOT / "ontocode-rs" / "responses-api-proxy" / "npm"
...
def main() -> int:
    ...
    try:
        ...
        if release_version:
            ...
            elif package == "ontocode-responses-api-proxy":
                print(
                    f"Staged version {version} for release in {staging_dir_str}\n\n"
                    "Verify the responses API proxy:\n"
                    f"    node {staging_dir_str}/bin/ontocode-responses-api-proxy.js --help\n\n"
                )
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex":
        ...
        bin_dir = staging_dir / "bin"
        bin_dir.mkdir(parents=True, exist_ok=True)
        launcher_src = RESPONSES_API_PROXY_NPM_ROOT / "bin" / "ontocode-responses-api-proxy.js"
        shutil.copy2(launcher_src, bin_dir / "ontocode-responses-api-proxy.js")
