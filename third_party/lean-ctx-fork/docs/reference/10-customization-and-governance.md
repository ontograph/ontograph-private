...
lean-ctx tools minimal             # ~10 core tools
lean-ctx tools standard            # the balanced everyday set (19 tools)
...
|---------|-------|----------|
| `minimal` | 10 | small models / strict token budgets |
| `standard` | 19 | most users — recommended everyday trim |
