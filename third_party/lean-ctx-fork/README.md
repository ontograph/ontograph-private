...
> **Ontocode maintained fork notice**
>
> This subtree is the adopted backend source for the repo-local
> `ontocode-lean-ctx` plugin. The supported Ontocode operator path is the repo
> root runtime flow:
>
...
>
> The inherited upstream install/update/onboard guidance below is donor
> documentation, not the supported Ontocode plugin runtime path.
