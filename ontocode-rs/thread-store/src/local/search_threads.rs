...
use ontocode_rollout::first_rollout_content_match_snippet;
use ontocode_rollout::parse_cursor;
use ontocode_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: ontocode_rollout::ThreadItem,
    snippet: String,
}
...
) -> Option<ontocode_rollout::Cursor> {
