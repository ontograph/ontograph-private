...
use ontocode_backend_client::ConfigBundleResponse;
use ontocode_backend_client::DeliveredTomlFragment;
use ontocode_config::AbsolutePathBuf;
use ontocode_config::CloudConfigFragment;
use ontocode_config::CloudConfigTomlBundle;
use ontocode_config::CloudRequirementsFragment;
use ontocode_config::CloudRequirementsTomlBundle;
...
fn bundle_response_conversion_preserves_fragment_order() {
    let response = ConfigBundleResponse {
        config_toml: Some(Some(Box::new(
            ontocode_backend_client::DeliveredConfigToml {
        ...
        requirements_toml: Some(Some(Box::new(
            ontocode_backend_client::DeliveredRequirementsToml {
