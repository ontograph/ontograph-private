...
ON CONFLICT(id) DO NOTHING
        ...
        .bind(
            metadata
                .thread_source
                .map(ontocode_protocol::protocol::ThreadSource::as_str),
        )
...
mod tests {
    ...
    async fn apply_rollout_items_uses_override_updated_at_when_provided() {
        ...
        let items = vec![RolloutItem::EventMsg(EventMsg::TokenCount(
            ontocode_protocol::protocol::TokenCountEvent {
                info: Some(ontocode_protocol::protocol::TokenUsageInfo {
                    total_token_usage: ontocode_protocol::protocol::TokenUsage {
                        input_tokens: 0,
                    ...
                    last_token_usage: ontocode_protocol::protocol::TokenUsage::default(),
