...
use ontocode_api::AuthError;
use ontocode_api::AuthProvider;
use ontocode_api::Compression;
use ontocode_api::Provider;
use ontocode_api::ResponsesApiRequest;
use ontocode_api::ResponsesClient;
use ontocode_api::ResponsesOptions;
use ontocode_client::HttpTransport;
use ontocode_client::Request;
use ontocode_client::RequestBody;
use ontocode_client::RequestTelemetry;
use ontocode_client::Response;
use ontocode_client::StreamResponse;
...
fn provider(name: &str) -> Provider {
    Provider {
        ...
        query_params: None,
        headers: HeaderMap::new(),
        retry: ontocode_api::RetryConfig {
            max_attempts: 1,
