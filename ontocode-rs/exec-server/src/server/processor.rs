    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                ontocode_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                ontocode_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                ontocode_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                ontocode_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
