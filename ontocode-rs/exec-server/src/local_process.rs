...
use ontocode_protocol::shell_environment;
use ontocode_utils_pty::ExecCommandSession;
...
impl LocalProcess {
    ...
    async fn start_process(
        ...
        let spawned_result = if params.tty {
            ...
            ontocode_utils_pty::spawn_pipe_process(
                program,
                args,
                params.cwd.as_path(),
                &env,
...
mod tests {
    ...
    use ontocode_utils_pty::ProcessDriver;
    ...
    fn dummy_session() -> ExecCommandSession {
        ...
        ontocode_utils_pty::spawn_from_driver(ProcessDriver {
            writer_tx,
            stdout_rx,
