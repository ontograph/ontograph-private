...
use ontocode_feedback::DOCTOR_REPORT_ATTACHMENT_FILENAME;
use ontocode_feedback::FEEDBACK_DIAGNOSTICS_ATTACHMENT_FILENAME;
use ontocode_feedback::FeedbackDiagnostics;
...
mod tests {
    ...
    use crate::app_event::AppEvent;
    use crate::app_event_sender::AppEventSender;
    use ontocode_feedback::FeedbackDiagnostic;
