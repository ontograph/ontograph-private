...
use ontocode_app_server_protocol::CommandExecutionSource as ExecCommandSource;
use ontocode_app_server_protocol::ConfigLayerSource;
use ontocode_app_server_protocol::CreditsSnapshot;
...
use ontocode_app_server_protocol::ModelVerification as AppServerModelVerification;
use ontocode_app_server_protocol::RateLimitReachedType;
...
use ontocode_app_server_protocol::SkillMetadata as ProtocolSkillMetadata;
use ontocode_app_server_protocol::SkillsListResponse;
use ontocode_app_server_protocol::ThreadGoal as AppThreadGoal;
use ontocode_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use ontocode_core_skills::model::SkillMetadata;
use ontocode_features::FEATURES;
use ontocode_features::Feature;
#[cfg(test)]
use ontocode_git_utils::CommitLogEntry;
use ontocode_git_utils::current_branch_name;
use ontocode_git_utils::get_git_repo_root;
use ontocode_git_utils::local_git_branches;
use ontocode_git_utils::recent_commits;
use ontocode_otel::RuntimeMetricsSummary;
use ontocode_otel::SessionTelemetry;
use ontocode_plugin::PluginCapabilitySummary;
use ontocode_protocol::ThreadId;
use ontocode_protocol::account::PlanType;
use ontocode_protocol::approvals::GuardianAssessmentAction;
use ontocode_protocol::approvals::GuardianAssessmentDecisionSource;
use ontocode_protocol::approvals::GuardianAssessmentEvent;
use ontocode_protocol::approvals::GuardianAssessmentStatus;
...
use ontocode_protocol::items::AgentMessageContent;
use ontocode_protocol::items::AgentMessageItem;
use ontocode_protocol::models::MessagePhase;
use ontocode_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use ontocode_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
use ontocode_protocol::request_permissions::RequestPermissionsEvent;
use ontocode_protocol::user_input::ByteRange;
use ontocode_protocol::user_input::TextElement;
use ontocode_terminal_detection::Multiplexer;
use ontocode_terminal_detection::TerminalInfo;
use ontocode_terminal_detection::TerminalName;
use ontocode_terminal_detection::terminal_info;
use ontocode_utils_absolute_path::AbsolutePathBuf;
use ontocode_utils_cli::resume_hint;
use ontocode_utils_plugins::mention_syntax::PLUGIN_TEXT_MENTION_SIGIL;
use ontocode_utils_plugins::mention_syntax::TOOL_MENTION_SIGIL;
use rand::Rng;
...
use ontocode_file_search::FileMatch;
...
use ontocode_utils_approval_presets::ApprovalPreset;
use ontocode_utils_approval_presets::builtin_approval_presets;
...
pub(crate) struct ChatWidget {
    ...
    mcp_tool_failure_streak_key: Option<String>,
    mcp_tool_failure_streak_count: u8,
...
fn request_permissions_from_params(
    params: ontocode_app_server_protocol::PermissionsRequestApprovalParams,
...
impl ChatWidget {
    ...
    pub(crate) fn open_feedback_consent(&mut self, category: crate::app_event::FeedbackCategory) {
        ...
        let include_windows_sandbox_log =
            ontocode_windows_sandbox::current_log_file_path_for_codex_home(&self.config.codex_home)
                .is_file();
                ...
                .filter_map(|item| match item {
                    ...
                    UserInput::Mention { name, path } => {
                        ...
                        let mention = if let Some(plugin_id) = plugin_id {
                            ...
                            ontocode_connectors::metadata::connector_mention_slug_from_name(name)
                        } else {
                            name.clone()
                        };
