...
use ontocode_app_server_protocol::HookOutputEntry;
use ontocode_app_server_protocol::HookOutputEntryKind;
use ontocode_app_server_protocol::HookRunStatus;
use ontocode_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
