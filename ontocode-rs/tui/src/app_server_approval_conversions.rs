...
use ontocode_app_server_protocol::GrantedPermissionProfile;
    ...
    fn converts_request_permissions_into_granted_permissions() {
        assert_eq!(
            granted_permission_profile_from_request(CoreRequestPermissionProfile::from(
                ontocode_app_server_protocol::RequestPermissionProfile {
                    network: Some(ontocode_app_server_protocol::AdditionalNetworkPermissions {
                        enabled: Some(true),
                    }),
                    file_system: Some(
                        ontocode_app_server_protocol::AdditionalFileSystemPermissions {
            ...
            ontocode_app_server_protocol::GrantedPermissionProfile {
                network: Some(ontocode_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: Some(
                ...
                ontocode_app_server_protocol::RequestPermissionProfile {
                    ...
                    file_system: Some(
                        ontocode_app_server_protocol::AdditionalFileSystemPermissions {
                            ...
                            glob_scan_max_depth: None,
                            entries: Some(
                                vec![ontocode_app_server_protocol::FileSystemSandboxEntry {
                            path: ontocode_app_server_protocol::FileSystemPath::Special {
                                value: ontocode_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: ontocode_app_server_protocol::FileSystemAccessMode::Write,
                        }]
                            ),
            ...
            ontocode_app_server_protocol::GrantedPermissionProfile {
                ...
                file_system: Some(
                    ontocode_app_server_protocol::AdditionalFileSystemPermissions {
                        ...
                        write: None,
                        glob_scan_max_depth: None,
                        entries: Some(vec![ontocode_app_server_protocol::FileSystemSandboxEntry {
                            path: ontocode_app_server_protocol::FileSystemPath::Special {
                                value: ontocode_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: ontocode_app_server_protocol::FileSystemAccessMode::Write,
