...
use ontocode_realtime_webrtc::RealtimeWebrtcEvent;
use ontocode_realtime_webrtc::RealtimeWebrtcSessionHandle;
...
pub(crate) enum AppEvent {
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<ontocode_app_server_protocol::HooksListResponse, String>,
    },
    ...
    /// Persist the selected model, provider, and reasoning effort to the appropriate config.
