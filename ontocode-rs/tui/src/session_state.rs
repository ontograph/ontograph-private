...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: ontocode_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<ontocode_protocol::openai_models::ReasoningEffort>,
