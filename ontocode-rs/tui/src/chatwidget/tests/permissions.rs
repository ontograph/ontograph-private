...
fn windows_sandbox_requirements_stack(
    ...
    let requirements_toml = ontocode_config::ConfigRequirementsToml {
        windows: Some(ontocode_config::WindowsRequirementsToml {
            allowed_sandbox_implementations: Some(allowed_sandbox_implementations),
        }),
        ..Default::default()
    };
    let mut requirements_with_sources = ontocode_config::ConfigRequirementsWithSources::default();
    requirements_with_sources
        .merge_unset_fields(RequirementSource::Unknown, requirements_toml.clone());
    let requirements = ontocode_config::ConfigRequirements::try_from(requirements_with_sources)
