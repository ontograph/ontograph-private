...
async fn interrupted_turn_after_goal_budget_limited_uses_budget_message_snapshot() {
    ...
    chat.handle_server_notification(
        ontocode_app_server_protocol::ServerNotification::TurnStarted(
            ontocode_app_server_protocol::TurnStartedNotification {
                thread_id: "thread-1".to_string(),
                turn: ontocode_app_server_protocol::Turn {
                    id: "turn-1".to_string(),
                    items_view: ontocode_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: ontocode_app_server_protocol::TurnStatus::InProgress,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
    ...
    chat.handle_server_notification(
        ontocode_app_server_protocol::ServerNotification::ThreadGoalUpdated(
            ontocode_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: ontocode_app_server_protocol::ThreadGoal {
                    ...
                    status: ontocode_app_server_protocol::ThreadGoalStatus::BudgetLimited,
        ...
        ontocode_app_server_protocol::ServerNotification::TurnCompleted(
            ontocode_app_server_protocol::TurnCompletedNotification {
                ...
                turn: ontocode_app_server_protocol::Turn {
                    ...
                    items_view: ontocode_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: ontocode_app_server_protocol::TurnStatus::Interrupted,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
