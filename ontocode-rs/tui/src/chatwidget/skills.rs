...
use ontocode_app_server_protocol::SkillsListEntry;
use ontocode_app_server_protocol::SkillsListResponse;
use ontocode_core_skills::model::SkillDependencies;
use ontocode_core_skills::model::SkillInterface;
use ontocode_core_skills::model::SkillMetadata;
use ontocode_core_skills::model::SkillToolDependency;
...
pub(crate) fn find_app_mentions(
    ...
    for app in apps.iter().filter(|app| is_app_mentionable(app)) {
        let slug = ontocode_connectors::metadata::connector_mention_slug(app);
