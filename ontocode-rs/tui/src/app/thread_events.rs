...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<ontocode_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use ontocode_app_server_protocol::HookEventName as AppServerHookEventName;
    use ontocode_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use ontocode_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use ontocode_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use ontocode_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use ontocode_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use ontocode_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use ontocode_app_server_protocol::HookScope as AppServerHookScope;
