...
mod tests {
    ...
    use ontocode_app_server_protocol::PermissionGrantScope;
    use ontocode_app_server_protocol::PermissionsRequestApprovalParams;
    use ontocode_app_server_protocol::PermissionsRequestApprovalResponse;
    use ontocode_app_server_protocol::RequestId as AppServerRequestId;
    use ontocode_app_server_protocol::ServerRequest;
    use ontocode_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: ontocode_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: ontocode_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: ontocode_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        entries: Some(vec![
                            ontocode_app_server_protocol::FileSystemSandboxEntry {
                                path: ontocode_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path),
                                },
                                access: ontocode_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            ontocode_app_server_protocol::FileSystemSandboxEntry {
                                path: ontocode_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path),
                                },
                                access: ontocode_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: ontocode_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: ontocode_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason:
                        ontocode_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
