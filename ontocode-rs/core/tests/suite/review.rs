...
use ontocode_core::REVIEW_PROMPT;
use ontocode_core::config::Config;
use ontocode_core::review_format::render_review_output_text;
use ontocode_protocol::models::ContentItem;
use ontocode_protocol::models::ResponseItem;
use ontocode_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
use ontocode_protocol::protocol::EventMsg;
use ontocode_protocol::protocol::ExitedReviewModeEvent;
use ontocode_protocol::protocol::Op;
use ontocode_protocol::protocol::ReviewCodeLocation;
use ontocode_protocol::protocol::ReviewFinding;
use ontocode_protocol::protocol::ReviewLineRange;
...
async fn review_input_isolated_from_parent_history() {
    ...
    let session_file = codex_home.path().join("resume.jsonl");
    {
        ...
        let user = ontocode_protocol::models::ResponseItem::Message {
            id: None,
            role: "user".to_string(),
        ...
        let assistant = ontocode_protocol::models::ResponseItem::Message {
            id: None,
