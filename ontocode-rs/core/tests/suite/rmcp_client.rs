...
use ontocode_exec_server::HttpRequestParams;
use ontocode_login::CodexAuth;
use ontocode_mcp::MCP_SANDBOX_STATE_META_CAPABILITY;
...
use ontocode_utils_cargo_bin::cargo_bin;
use reqwest::Client;
...
fn remote_aware_environment_id() -> String {
    ...
    std::env::var_os(remote_env_env_var())
        ...
        .unwrap_or_else(|| ontocode_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string())
}
        ...
        ModelsResponse {
            models: vec![ModelInfo {
                ...
                supported_reasoning_levels: vec![ReasoningEffortPreset {
                    effort: ontocode_protocol::openai_models::ReasoningEffort::Medium,
