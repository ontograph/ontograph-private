...
use ontocode_api::WS_REQUEST_HEADER_TRACEPARENT_CLIENT_METADATA_KEY;
use ontocode_api::WS_REQUEST_HEADER_TRACESTATE_CLIENT_METADATA_KEY;
use ontocode_core::ModelClient;
use ontocode_core::ModelClientSession;
use ontocode_core::Prompt;
use ontocode_core::ResponseEvent;
use ontocode_core::X_RESPONSESAPI_INCLUDE_TIMING_METRICS_HEADER;
...
use ontocode_rollout_trace::ConversationPart;
use ontocode_rollout_trace::InferenceTraceContext;
use ontocode_rollout_trace::RawTraceEventPayload;
use ontocode_rollout_trace::TraceWriter;
...
async fn responses_websocket_streams_request() {
    ...
    assert_eq!(
        ...
        Some(ontocode_login::default_client::get_codex_user_agent())
    );
    assert_eq!(
...
async fn websocket_harness_with_provider_options(
    ...
    let model_info = ontocode_core::test_support::construct_model_info_offline(MODEL, &config);
