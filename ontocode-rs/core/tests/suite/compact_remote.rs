...
async fn start_realtime_conversation(codex: &ontocode_core::CodexThread) -> Result<()> {
    codex
...
async fn close_realtime_conversation(codex: &ontocode_core::CodexThread) -> Result<()> {
...
async fn wait_for_turn_complete(codex: &ontocode_core::CodexThread) {
