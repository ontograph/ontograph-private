...
use ontocode_extension_api::ToolCall as ExtensionToolCall;
...
impl ontocode_extension_api::ToolContributor for ExtensionEchoContributor {
    fn tools(
        &self,
    ...
    fn spec(&self) -> ToolSpec {
        ToolSpec::Namespace(ResponsesApiNamespace {
            ...
            tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                ...
                strict: true,
                parameters: ontocode_extension_api::parse_tool_input_schema(&json!({
                    "type": "object",
                    "properties": {
                        "message": { "type": "string" },
                    },
