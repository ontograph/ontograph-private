...
#[cfg(target_os = "macos")]
use ontocode_network_proxy::CODEX_PROXY_GIT_SSH_COMMAND_MARKER;
use ontocode_network_proxy::CUSTOM_CA_ENV_KEYS;
...
use ontocode_network_proxy::PROXY_ACTIVE_ENV_KEY;
use ontocode_network_proxy::PROXY_ENV_KEYS;
#[cfg(target_os = "macos")]
use ontocode_network_proxy::PROXY_GIT_SSH_COMMAND_ENV_KEY;
...
async fn test_network_proxy() -> anyhow::Result<NetworkProxy> {
    let state = ontocode_network_proxy::build_config_state(
