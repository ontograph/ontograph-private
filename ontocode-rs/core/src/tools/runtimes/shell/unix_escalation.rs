...
use ontocode_shell_escalation::EscalateServer;
use ontocode_shell_escalation::EscalationDecision;
use ontocode_shell_escalation::EscalationExecution;
use ontocode_shell_escalation::EscalationPermissions;
use ontocode_shell_escalation::EscalationPolicy;
use ontocode_shell_escalation::EscalationSession;
use ontocode_shell_escalation::ExecParams;
use ontocode_shell_escalation::ExecResult;
use ontocode_shell_escalation::PreparedExec;
use ontocode_shell_escalation::ResolvedPermissionProfile;
use ontocode_shell_escalation::ShellCommandExecutor;
use ontocode_shell_escalation::Stopwatch;
        ...
        Ok(stopwatch
            .pause_for(async move {
                ...
                let permission_request = PermissionRequestPayload::bash(
                    ontocode_shell_command::parse_command::shlex_join(&command),
                    /*description*/ None,
                );
...
struct CoreShellCommandExecutor {
    ...
    network: Option<ontocode_network_proxy::NetworkProxy>,
