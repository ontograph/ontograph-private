...
use ontocode_tools::ConversationHistory;
use ontocode_tools::ExtensionTurnItem;
...
use ontocode_tools::TurnItemEmissionFuture;
use ontocode_tools::TurnItemEmitter;
...
pub(crate) struct ExtensionToolAdapter(Arc<dyn ontocode_tools::ToolExecutor<ExtensionToolCall>>);

impl ExtensionToolAdapter {
    pub(crate) fn new(executor: Arc<dyn ontocode_tools::ToolExecutor<ExtensionToolCall>>) -> Self {
        Self(executor)
    }
}
    ...
    fn emit_completed<'a>(&'a self, item: ExtensionTurnItem) -> TurnItemEmissionFuture<'a> {
        Box::pin(async move {
            ...
            finalize_turn_item(
                ...
                &mut item,
                turn.collaboration_mode.mode == ontocode_protocol::config_types::ModeKind::Plan,
            )
            .await;
...
mod tests {
    ...
    use ontocode_extension_api::TurnItemContributor;
    use ontocode_protocol::items::TurnItem;
    ...
    #[async_trait::async_trait]
    impl ontocode_extension_api::ToolExecutor<ontocode_tools::ToolCall> for StubExtensionExecutor {
        fn tool_name(&self) -> ontocode_tools::ToolName {
            ontocode_tools::ToolName::plain("extension_echo")
        }

        fn spec(&self) -> ontocode_tools::ToolSpec {
            ontocode_tools::ToolSpec::Function(ontocode_tools::ResponsesApiTool {
                name: "extension_echo".to_string(),
                description: "Echoes arguments.".to_string(),
                strict: true,
                parameters: ontocode_tools::parse_tool_input_schema(&json!({
                    "type": "object",
                    "properties": {
                        "message": { "type": "string" },
                    },
        ...
        async fn handle(
            &self,
            _call: ontocode_tools::ToolCall,
        ) -> Result<Box<dyn ontocode_tools::ToolOutput>, ontocode_tools::FunctionCallError>
        {
            Ok(Box::new(ontocode_tools::JsonToolOutput::new(
                json!({ "ok": true }),
            )))
        }
    }
    ...
    struct CapturingExtensionExecutor {
        captured_call: Arc<Mutex<Option<ontocode_tools::ToolCall>>>,
    }

    #[async_trait::async_trait]
    impl ontocode_extension_api::ToolExecutor<ontocode_tools::ToolCall> for CapturingExtensionExecutor {
        fn tool_name(&self) -> ontocode_tools::ToolName {
            ontocode_tools::ToolName::plain("extension_echo")
        }
    ...
    async fn exposes_generic_hook_payloads() {
        ...
        let invocation = ToolInvocation {
            ...
            tool_name: ontocode_tools::ToolName::plain("extension_echo"),
            source: ToolCallSource::Direct,
            payload: ToolPayload::Function {
                arguments: json!({ "message": "hello" }).to_string(),
            },
        };
        let output = ontocode_tools::JsonToolOutput::new(json!({ "ok": true }));
    ...
    async fn extension_completion_runs_turn_item_contributors() {
        ...
        ontocode_tools::TurnItemEmitter::emit_completed(
            &emitter,
    ...
    #[async_trait::async_trait]
    impl ontocode_extension_api::ToolExecutor<ontocode_tools::ToolCall>
        for ImageGenerationExtensionExecutor
    {
        fn tool_name(&self) -> ontocode_tools::ToolName {
            ontocode_tools::ToolName::namespaced("image_gen", "imagegen")
        }
        ...
        ) -> Result<Box<dyn ontocode_tools::ToolOutput>, ontocode_tools::FunctionCallError>
        {
            call.turn_item_emitter
                .emit_started(ExtensionTurnItem::ImageGeneration(
                    ontocode_protocol::items::ImageGenerationItem {
                        id: call.call_id.clone(),
    ...
    async fn image_generation_publication_is_finalized_by_core() {
        ...
        let invocation = ToolInvocation {
            ...
            tool_name: ontocode_tools::ToolName::namespaced("image_gen", "imagegen"),
            source: ToolCallSource::Direct,
            payload: ToolPayload::Function {
                arguments: "{}".to_string(),
            },
