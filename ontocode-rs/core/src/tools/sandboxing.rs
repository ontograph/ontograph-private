...
use ontocode_protocol::approvals::NetworkApprovalContext;
...
use ontocode_sandboxing::SandboxTransformError;
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a ontocode_protocol::models::PermissionProfile,
        ...
        self.manager
            ...
            .map(|request| {
                let windows_sandbox_policy_cwd =
                    ontocode_utils_absolute_path::AbsolutePathBuf::try_from(
