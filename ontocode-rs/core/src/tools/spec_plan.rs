...
fn append_extension_tool_executors(
    ...
    if matches!(
        ...
        reserved_tool_names.insert(ToolName::plain(ontocode_code_mode::PUBLIC_TOOL_NAME));
        reserved_tool_names.insert(ToolName::plain(ontocode_code_mode::WAIT_TOOL_NAME));
    }
