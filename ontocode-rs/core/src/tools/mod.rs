...
) -> ontocode_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => ontocode_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => ontocode_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => ontocode_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => ontocode_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => ontocode_tools::ToolUserShellType::Cmd,
    }
}
...
pub fn format_exec_output_for_model(
    ...
    let reduced_content = output_reducer::reduce_exec_output(&content);

    let total_lines = content.lines().count();
    let formatted_output = truncate_text(reduced_content.as_ref(), truncation_policy);
...
pub fn format_exec_output_str(
    ...
    formatted_truncate_text(reduced_content.as_ref(), truncation_policy)
}
