...
use ontocode_protocol::protocol::ThreadSettingsAppliedEvent;
use ontocode_protocol::protocol::ThreadSettingsOverrides;
use ontocode_protocol::protocol::ThreadSettingsSnapshot;
...
use ontocode_protocol::mcp::RequestId as ProtocolRequestId;
...
pub async fn resolve_elicitation(
    ...
    decision: ontocode_protocol::approvals::ElicitationAction,
    content: Option<Value>,
    meta: Option<Value>,
) {
    let action = match decision {
        ontocode_protocol::approvals::ElicitationAction::Accept => ElicitationAction::Accept,
        ontocode_protocol::approvals::ElicitationAction::Decline => ElicitationAction::Decline,
        ontocode_protocol::approvals::ElicitationAction::Cancel => ElicitationAction::Cancel,
    };
...
async fn emit_thread_stop_lifecycle(sess: &Session) {
    for contributor in sess.services.extensions.thread_lifecycle_contributors() {
        contributor
            .on_thread_stop(ontocode_extension_api::ThreadStopInput {
...
pub async fn shutdown(sess: &Arc<Session>, sub_id: String) -> bool {
    ...
    sess.services
        .rollout_thread_trace
        .record_ended(ontocode_rollout_trace::RolloutStatus::Completed);
    true
}
