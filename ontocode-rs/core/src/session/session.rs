        ...
        if let Some(model_provider_id) = updates.model_provider.clone() {
            let provider = next_configuration
                ...
                .ok_or_else(|| ConstraintError::InvalidValue {
                    ...
                    requirement_source: ontocode_config::RequirementSource::Unknown,
                })?;
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        extensions: Arc<ontocode_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let trace_agent_path = session_configuration
                .session_source
                .get_agent_path()
                .unwrap_or_else(ontocode_protocol::AgentPath::root);
            let trace_task_name =
            ...
            let session_extension_data =
                ontocode_extension_api::ExtensionData::new(session_id.to_string());
            let thread_extension_data =
                ontocode_extension_api::ExtensionData::new(thread_id.to_string());
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(ontocode_extension_api::ThreadStartInput {
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => ontocode_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    ontocode_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => ontocode_hooks::SessionStartSource::Clear,
            };
