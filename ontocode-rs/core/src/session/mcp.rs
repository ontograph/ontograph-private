use super::*;
use ontocode_mcp::ElicitationReviewRequest;
use ontocode_mcp::ElicitationReviewer;
use ontocode_mcp::ElicitationReviewerHandle;
use ontocode_protocol::config_types::ApprovalsReviewer;
use ontocode_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as MCP_ELICITATION_APPROVAL_KIND_KEY;
use ontocode_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as MCP_ELICITATION_APPROVAL_KIND_MCP_TOOL_CALL;
use ontocode_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as MCP_ELICITATION_APPROVAL_KIND_TOOL_SUGGESTION;
use ontocode_protocol::mcp_approval_meta::APPROVALS_REVIEWER_KEY as MCP_ELICITATION_APPROVALS_REVIEWER_KEY;
use ontocode_protocol::mcp_approval_meta::CONNECTOR_DESCRIPTION_KEY as MCP_ELICITATION_CONNECTOR_DESCRIPTION_KEY;
use ontocode_protocol::mcp_approval_meta::CONNECTOR_ID_KEY as MCP_ELICITATION_CONNECTOR_ID_KEY;
use ontocode_protocol::mcp_approval_meta::CONNECTOR_NAME_KEY as MCP_ELICITATION_CONNECTOR_NAME_KEY;
use ontocode_protocol::mcp_approval_meta::REQUEST_TYPE_APPROVAL_REQUEST as MCP_ELICITATION_REQUEST_TYPE_APPROVAL_REQUEST;
use ontocode_protocol::mcp_approval_meta::REQUEST_TYPE_KEY as MCP_ELICITATION_REQUEST_TYPE_KEY;
use ontocode_protocol::mcp_approval_meta::TOOL_DESCRIPTION_KEY as MCP_ELICITATION_TOOL_DESCRIPTION_KEY;
use ontocode_protocol::mcp_approval_meta::TOOL_NAME_KEY as MCP_ELICITATION_TOOL_NAME_KEY;
use ontocode_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as MCP_ELICITATION_TOOL_PARAMS_KEY;
use ontocode_protocol::mcp_approval_meta::TOOL_TITLE_KEY as MCP_ELICITATION_TOOL_TITLE_KEY;
    ...
    pub async fn request_mcp_server_elicitation(
        ...
        let request = match params.request {
            McpServerElicitationRequest::Form {
                ...
                ontocode_protocol::approvals::ElicitationRequest::Form {
                    meta,
                    message,
                    requested_schema,
                }
            ...
            McpServerElicitationRequest::Url {
                ...
                url,
                elicitation_id,
            } => ontocode_protocol::approvals::ElicitationRequest::Url {
                meta,
                message,
                url,
                elicitation_id,
        ...
        let id = match request_id {
            rmcp::model::NumberOrString::String(value) => {
                ontocode_protocol::mcp::RequestId::String(value.to_string())
            }
            rmcp::model::NumberOrString::Number(value) => {
                ontocode_protocol::mcp::RequestId::Integer(value)
            }
        };
...
fn plugin_install_elicitation_telemetry_metadata(
    ...
    let ontocode_protocol::approvals::ElicitationRequest::Form {
