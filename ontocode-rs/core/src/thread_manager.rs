...
use ontocode_thread_store::LocalThreadStoreConfig;
use ontocode_thread_store::ReadThreadByRolloutPathParams;
...
pub struct StartThreadOptions {
    ...
    pub dynamic_tools: Vec<ontocode_protocol::dynamic_tools::DynamicToolSpec>,
...
pub fn thread_store_from_config(
    ...
    match &config.experimental_thread_store {
        ThreadStoreConfig::Local => {
            ...
            {
                ontocode_rollout::spawn_rollout_compression_worker(config.codex_home.to_path_buf());
            }
...
impl ThreadManager {
    ...
    pub async fn start_thread_with_tools(
        &self,
        config: Config,
        dynamic_tools: Vec<ontocode_protocol::dynamic_tools::DynamicToolSpec>,
...
impl ThreadManagerState {
    ...
    async fn parent_rollout_thread_trace_for_source(
        ...
        session_source: &SessionSource,
        initial_history: &InitialHistory,
    ) -> ontocode_rollout_trace::ThreadTraceContext {
        ...
        let SessionSource::SubAgent(SubAgentSource::ThreadSpawn {
            ...
            return ontocode_rollout_trace::ThreadTraceContext::disabled();
        };
        ...
        self.get_thread(*parent_thread_id)
            ...
            .unwrap_or_else(ontocode_rollout_trace::ThreadTraceContext::disabled)
    }
}
