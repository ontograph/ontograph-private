...
use ontocode_rollout_trace::CompactionCheckpointTracePayload;
    ...
    match pre_compact_outcome {
        ...
        PreCompactHookOutcome::Stopped { reason } => {
            ...
            attempt
                .track(
                    sess.as_ref(),
                    ontocode_analytics::CompactionStatus::Interrupted,
                    Some(error),
...
pub(crate) fn log_remote_compact_failure(
    ...
    error!(
        ...
        estimated_model_tokens_in_history = total_usage_breakdown.model_tokens,
        estimated_tool_tokens_in_history = total_usage_breakdown.tool_tokens,
