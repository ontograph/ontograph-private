...
pub use ontocode_protocol::models::SandboxPermissions;
...
pub(crate) struct ExecServerEnvConfig {
    pub(crate) policy: ontocode_exec_server::ExecEnvPolicy,
...
) -> ontocode_protocol::error::Result<ExecToolCallOutput> {
