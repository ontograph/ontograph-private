...
use ontocode_config::config_toml::AgentRoleToml;
use ontocode_config::config_toml::AgentsToml;
use ontocode_config::config_toml::AutoReviewToml;
use ontocode_config::config_toml::ConfigToml;
use ontocode_config::config_toml::ExperimentalRequestUserInput;
use ontocode_config::config_toml::ProjectConfig;
use ontocode_config::config_toml::RealtimeConfig;
use ontocode_config::config_toml::RealtimeToml;
use ontocode_config::config_toml::RealtimeTransport;
use ontocode_config::config_toml::RealtimeWsMode;
use ontocode_config::config_toml::RealtimeWsVersion;
use ontocode_config::config_toml::ToolsToml;
...
use ontocode_config::permissions_toml::NetworkDomainPermissionToml;
use ontocode_config::permissions_toml::NetworkDomainPermissionsToml;
use ontocode_config::permissions_toml::NetworkMitmActionToml;
use ontocode_config::permissions_toml::NetworkMitmHookToml;
use ontocode_config::permissions_toml::NetworkMitmToml;
...
use ontocode_config::permissions_toml::WorkspaceRootsToml;
use ontocode_config::types::AppToolApproval;
use ontocode_config::types::ApprovalsReviewer;
use ontocode_config::types::BundledSkillsConfig;
use ontocode_config::types::FeedbackConfigToml;
use ontocode_config::types::HistoryPersistence;
use ontocode_config::types::McpServerEnvVar;
use ontocode_config::types::McpServerOAuthConfig;
use ontocode_config::types::McpServerToolConfig;
...
use ontocode_config::types::NotificationCondition;
use ontocode_config::types::NotificationMethod;
use ontocode_config::types::Notifications;
use ontocode_config::types::OtelConfigToml;
use ontocode_config::types::OtelExporterKind;
use ontocode_config::types::SandboxWorkspaceWrite;
use ontocode_config::types::SessionPickerViewMode;
use ontocode_config::types::SkillsConfig;
use ontocode_config::types::ToolSuggestDisabledTool;
use ontocode_config::types::ToolSuggestDiscoverableType;
use ontocode_config::types::Tui;
...
use ontocode_network_proxy::NetworkMode;
...
use ontocode_protocol::protocol::NetworkAccess;
...
use ontocode_config::test_support::CloudConfigBundleFixture;
...
fn stdio_mcp(command: &str) -> McpServerConfig {
    McpServerConfig {
        ...
        environment_id: ontocode_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string(),
        enabled: true,
        required: false,
...
-> std::io::Result<()> {
    ...
    requirements.network = Some(Sourced::new(
        ontocode_config::NetworkConstraints {
            enabled: Some(true),
            ..Default::default()
        },
...
fn filter_plugin_mcp_servers_by_allowlist_enforces_plugin_and_identity_rules() {
    ...
    let requirements = Sourced::new(
        BTreeMap::from([(
            ...
            ontocode_config::PluginRequirementsToml {
...
async fn rebuild_preserving_session_layers_refreshes_requirements() -> std::io::Result<()> {
    ...
    let requirements_toml = ontocode_config::ConfigRequirementsToml {
        mcp_servers: Some(mcp_requirements.clone()),
        ..Default::default()
    };
    let requirements = ontocode_config::ConfigRequirements {
    ...
    let refreshed_layer_stack = ConfigLayerStack::new(
        vec![
            ConfigLayerEntry::new(
                ontocode_app_server_protocol::ConfigLayerSource::User {
            ...
            ConfigLayerEntry::new(
                ontocode_app_server_protocol::ConfigLayerSource::Project {
            ...
            ConfigLayerEntry::new(
                ontocode_app_server_protocol::ConfigLayerSource::LegacyManagedConfigTomlFromMdm,
                toml::toml! {
                    [mcp_servers.managed_overrides_session]
    ...
    let thread_layer_stack = ConfigLayerStack::new(
        vec![
            ...
            ConfigLayerEntry::new(
                ontocode_app_server_protocol::ConfigLayerSource::SessionFlags,
                toml::toml! {
                    [mcp_servers.session_overrides_user]
...
async fn load_config_uses_requirements_guardian_policy_config() -> std::io::Result<()> {
    ...
    let config_layer_stack = ConfigLayerStack::new(
        Vec::new(),
        Default::default(),
        ontocode_config::ConfigRequirementsToml {
...
"#,
    ...
    let config_layer_stack = ontocode_config::ConfigLayerStack::new(
        vec![ontocode_config::ConfigLayerEntry::new(
            ontocode_app_server_protocol::ConfigLayerSource::User {
        ...
        Default::default(),
        ontocode_config::ConfigRequirementsToml::default(),
    )
    .map_err(std::io::Error::other)?;
...
async fn trace_exporter_defaults_to_none_when_log_exporter_is_set() -> std::io::Result<()> {
    ...
    cfg.otel = Some(OtelConfigToml {
        exporter: Some(OtelExporterKind::OtlpHttp {
            ...
            headers: HashMap::new(),
            protocol: ontocode_config::types::OtelHttpProtocol::Binary,
            tls: None,
        }),
...
async fn test_requirements_web_search_mode_allowlist_does_not_warn_when_unset() -> anyhow::Result<()>
{
    ...
    let requirements_toml = ontocode_config::ConfigRequirementsToml {
        ...
        allowed_web_search_modes: Some(vec![ontocode_config::WebSearchModeRequirement::Cached]),
    ...
    let requirement_source = ontocode_config::RequirementSource::Unknown;
    ...
    let requirements = ontocode_config::ConfigRequirements {
        web_search_mode: ontocode_config::ConstrainedWithSource::new(
            constrained,
    ...
    let config_layer_stack =
        ontocode_config::ConfigLayerStack::new(Vec::new(), requirements, requirements_toml)
...
"#,
    ...
    assert_eq!(
        ...
        Some(ontocode_config::types::WindowsSandboxModeToml::Elevated)
    );
    assert!(
...
#[tokio::test]
async fn multi_agent_v2_default_session_thread_cap_allows_five_children() -> std::io::Result<()> {
    let codex_home = TempDir::new()?;
    std::fs::write(
        codex_home.path().join(CONFIG_TOML_FILE),
        r#"[features.multi_agent_v2]
