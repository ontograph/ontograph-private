use ontocode_core_skills::AvailableSkills;
use ontocode_core_skills::render_available_skills_body;
use ontocode_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
