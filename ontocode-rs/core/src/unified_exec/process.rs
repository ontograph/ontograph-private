...
use ontocode_exec_server::ReadResponse as ExecReadResponse;
...
use ontocode_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = ontocode_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
