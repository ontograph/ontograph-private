...
use ontocode_thread_store::ThreadStoreResult;
...
impl ThreadConfigSnapshot {
    pub fn sandbox_policy(&self) -> SandboxPolicy {
        ontocode_sandboxing::compatibility_sandbox_policy_for_permission_profile(
...
impl CodexThread {
    ...
    pub(crate) async fn emit_thread_resume_lifecycle(&self) {
        ...
        {
            contributor
                .on_thread_resume(ontocode_extension_api::ThreadResumeInput {
