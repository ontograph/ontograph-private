...
//!
//! Use [`crate::default_client`] or [`ontocode_login::default_client`] from other crates in this
//! workspace.

use ontocode_client::BuildCustomCaTransportError;
use ontocode_client::CodexHttpClient;
pub use ontocode_client::CodexRequestBuilder;
...
pub use ontocode_config::ResidencyRequirement;
