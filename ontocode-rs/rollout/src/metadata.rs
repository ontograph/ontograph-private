...
use ontocode_state::BackfillState;
use ontocode_state::BackfillStats;
use ontocode_state::BackfillStatus;
use ontocode_state::DB_ERROR_METRIC;
use ontocode_state::DB_METRIC_BACKFILL;
use ontocode_state::DB_METRIC_BACKFILL_DURATION_MS;
use ontocode_state::ExtractionOutcome;
use ontocode_state::ThreadMetadataBuilder;
use ontocode_state::apply_rollout_item;
use std::path::Path;
...
pub(crate) async fn backfill_sessions_with_lease(
    ...
    let metric_client = ontocode_otel::global();
