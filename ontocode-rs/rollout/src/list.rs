...
use crate::state_db;
use ontocode_file_search as file_search;
...
impl From<ontocode_state::Anchor> for Cursor {
    fn from(anchor: ontocode_state::Anchor) -> Self {
        let ts = anchor
            .ts
            .timestamp_nanos_opt()
...
async fn find_thread_path_by_id_str_in_subdir(
    ...
    subdir: &str,
    id_str: &str,
    state_db_ctx: Option<&ontocode_state::StateRuntime>,
