...
fn to_state_status(
    status: ThreadSpawnEdgeStatus,
) -> ontocode_state::DirectionalThreadSpawnEdgeStatus {
    match status {
        ThreadSpawnEdgeStatus::Open => ontocode_state::DirectionalThreadSpawnEdgeStatus::Open,
        ThreadSpawnEdgeStatus::Closed => ontocode_state::DirectionalThreadSpawnEdgeStatus::Closed,
    }
}
