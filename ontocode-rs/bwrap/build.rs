...
/// 2. The vendored bubblewrap tree under `ontocode-rs/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under ontocode-rs/vendor.",
        vendor_dir.display()
    ))
}
