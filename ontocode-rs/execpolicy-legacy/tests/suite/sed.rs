extern crate ontocode_execpolicy_legacy;

use ontocode_execpolicy_legacy::ArgType;
use ontocode_execpolicy_legacy::Error;
use ontocode_execpolicy_legacy::ExecCall;
use ontocode_execpolicy_legacy::MatchedArg;
use ontocode_execpolicy_legacy::MatchedExec;
use ontocode_execpolicy_legacy::MatchedFlag;
use ontocode_execpolicy_legacy::MatchedOpt;
use ontocode_execpolicy_legacy::Policy;
use ontocode_execpolicy_legacy::Result;
use ontocode_execpolicy_legacy::ValidExec;
use ontocode_execpolicy_legacy::get_default_policy;
