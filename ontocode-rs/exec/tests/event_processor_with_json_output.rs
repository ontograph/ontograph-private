use ontocode_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use ontocode_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use ontocode_app_server_protocol::CollabAgentTool;
use ontocode_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use ontocode_app_server_protocol::CommandAction;
use ontocode_app_server_protocol::CommandExecutionSource;
use ontocode_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use ontocode_app_server_protocol::ErrorNotification;
use ontocode_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use ontocode_app_server_protocol::McpToolCallResult;
use ontocode_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use ontocode_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use ontocode_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use ontocode_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use ontocode_protocol::SessionId;
use ontocode_protocol::ThreadId;
use ontocode_protocol::models::PermissionProfile;
use ontocode_protocol::models::WebSearchAction;
...
use ontocode_exec::AgentMessageItem;
use ontocode_exec::CodexStatus;
use ontocode_exec::CollabAgentState;
use ontocode_exec::CollabAgentStatus;
use ontocode_exec::CollabTool;
use ontocode_exec::CollabToolCallItem;
use ontocode_exec::CollabToolCallStatus;
use ontocode_exec::CollectedThreadEvents;
use ontocode_exec::CommandExecutionItem;
use ontocode_exec::CommandExecutionStatus;
use ontocode_exec::ErrorItem;
use ontocode_exec::EventProcessorWithJsonOutput;
use ontocode_exec::ExecThreadItem;
use ontocode_exec::FileChangeItem;
use ontocode_exec::FileUpdateChange as ExecFileUpdateChange;
use ontocode_exec::ItemCompletedEvent;
use ontocode_exec::ItemStartedEvent;
use ontocode_exec::ItemUpdatedEvent;
use ontocode_exec::McpToolCallItem;
use ontocode_exec::McpToolCallItemError;
use ontocode_exec::McpToolCallItemResult;
use ontocode_exec::McpToolCallStatus;
use ontocode_exec::PatchApplyStatus;
use ontocode_exec::PatchChangeKind;
use ontocode_exec::ReasoningItem;
use ontocode_exec::ThreadErrorEvent;
use ontocode_exec::ThreadEvent;
use ontocode_exec::ThreadItemDetails;
use ontocode_exec::ThreadStartedEvent;
use ontocode_exec::TodoItem;
use ontocode_exec::TodoListItem;
use ontocode_exec::TurnCompletedEvent;
use ontocode_exec::TurnFailedEvent;
use ontocode_exec::TurnStartedEvent;
use ontocode_exec::Usage;
use ontocode_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        approvals_reviewer: ontocode_protocol::config_types::ApprovalsReviewer::User,
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            ontocode_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        ontocode_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: ontocode_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
