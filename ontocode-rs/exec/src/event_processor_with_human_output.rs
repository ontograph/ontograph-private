...
use ontocode_protocol::num_format::format_with_separators;
use ontocode_protocol::protocol::SessionConfiguredEvent;
use ontocode_utils_sandbox_summary::summarize_permission_profile;
            ...
            ServerNotification::TurnPlanUpdated(notification) => {
                ...
                for step in notification.plan {
                    match step.status {
                        ...
                        ontocode_app_server_protocol::TurnPlanStepStatus::InProgress => {
                            eprintln!("  {} {}", "→".style(self.cyan), step.step);
                        }
                        ontocode_app_server_protocol::TurnPlanStepStatus::Pending => {
                            eprintln!(
                                "  {} {}",
                                "•".style(self.dimmed),
