//! Entry-point for the `ontocode-exec` binary.
//!
//! When this CLI is invoked normally, it parses the standard `ontocode-exec` CLI
...
//! of the `ontocode-exec` binary.
use clap::Parser;
use ontocode_arg0::Arg0DispatchPaths;
use ontocode_arg0::arg0_dispatch_or_else;
use ontocode_exec::Cli;
use ontocode_exec::run_main;
