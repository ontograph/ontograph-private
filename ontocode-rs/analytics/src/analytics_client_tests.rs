...
use ontocode_app_server_protocol::ApprovalsReviewer as AppServerApprovalsReviewer;
use ontocode_app_server_protocol::AskForApproval as AppServerAskForApproval;
...
use ontocode_app_server_protocol::CollabAgentTool;
use ontocode_app_server_protocol::CollabAgentToolCallStatus;
use ontocode_app_server_protocol::CommandAction;
...
use ontocode_app_server_protocol::GuardianApprovalReview;
use ontocode_app_server_protocol::GuardianApprovalReviewAction;
use ontocode_app_server_protocol::GuardianApprovalReviewStatus;
use ontocode_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
...
use ontocode_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use ontocode_app_server_protocol::ItemStartedNotification;
use ontocode_app_server_protocol::JSONRPCErrorError;
use ontocode_app_server_protocol::McpToolCallStatus;
use ontocode_app_server_protocol::NonSteerableTurnKind;
use ontocode_app_server_protocol::PatchApplyStatus;
use ontocode_app_server_protocol::PermissionsRequestApprovalParams;
use ontocode_app_server_protocol::RequestId;
use ontocode_app_server_protocol::RequestPermissionProfile;
use ontocode_app_server_protocol::SandboxPolicy as AppServerSandboxPolicy;
use ontocode_app_server_protocol::ServerNotification;
use ontocode_app_server_protocol::ServerRequest;
use ontocode_app_server_protocol::ServerResponse;
use ontocode_app_server_protocol::SessionSource as AppServerSessionSource;
...
use ontocode_app_server_protocol::ThreadSource as AppServerThreadSource;
use ontocode_app_server_protocol::ThreadStartResponse;
use ontocode_app_server_protocol::ThreadStatus as AppServerThreadStatus;
...
use ontocode_app_server_protocol::TurnStatus as AppServerTurnStatus;
...
use ontocode_login::default_client::DEFAULT_ORIGINATOR;
use ontocode_login::default_client::originator;
use ontocode_plugin::AppConnectorId;
use ontocode_plugin::PluginCapabilitySummary;
use ontocode_plugin::PluginId;
use ontocode_plugin::PluginTelemetryMetadata;
use ontocode_protocol::approvals::NetworkApprovalProtocol;
...
use ontocode_protocol::models::PermissionProfile as CorePermissionProfile;
...
use ontocode_protocol::protocol::HookSource;
...
fn sample_app_server_client_metadata() -> CodexAppServerClientMetadata {
    CodexAppServerClientMetadata {
        ...
        client_name: Some("ontocode-tui".to_string()),
...
fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(ontocode_app_server_protocol::TurnStartResponse {
        turn: Turn {
...
fn sample_turn_completed_notification(
    ...
    codex_error_info: Option<ontocode_app_server_protocol::CodexErrorInfo>,
) -> ServerNotification {
    ...
    ServerRequest::PermissionsRequestApproval {
        ...
        params: PermissionsRequestApprovalParams {
            ...
            permissions: RequestPermissionProfile {
                network: Some(ontocode_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: None,
            },
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: ontocode_app_server_protocol::AutoReviewDecisionSource::Agent,
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        ontocode_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
...
fn subagent_thread_started_thread_spawn_serializes_parent_thread_id() {
    let parent_thread_id =
        ontocode_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
...
fn subagent_thread_started_other_serializes_explicit_parent_thread_id() {
    let parent_thread_id =
        ontocode_protocol::ThreadId::from_string("33333333-3333-4333-8333-333333333333")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
async fn subagent_thread_started_inherits_parent_connection_for_new_thread() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        ontocode_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    skill_scope: ontocode_protocol::protocol::SkillScope::User,
                    skill_path,
                    plugin_id: None,
...
async fn turn_lifecycle_emits_turn_event() {
    ...
    assert_eq!(
        ...
        json!({
            "product_client_id": "ontocode-tui",
            "client_name": "ontocode-tui",
            "client_version": "1.0.0",
            "rpc_transport": "stdio",
    ...
    reducer
        .ingest(
            AnalyticsFact::Notification(Box::new(sample_turn_completed_notification(
                ...
                Some(ontocode_app_server_protocol::CodexErrorInfo::BadRequest),
            ))),
            &mut out,
        )
        .await;
