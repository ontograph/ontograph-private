...
use ontocode_protocol::protocol::McpStartupCompleteEvent;
use ontocode_protocol::protocol::McpStartupFailure;
use ontocode_protocol::protocol::McpStartupStatus;
use ontocode_protocol::protocol::McpStartupUpdateEvent;
...
impl McpConnectionManager {
    ...
    pub async fn new(
        ...
        let codex_apps_auth_provider = auth
            ...
            .map(ontocode_model_provider::auth_provider_from_auth);
