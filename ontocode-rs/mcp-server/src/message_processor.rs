...
use ontocode_login::default_client::USER_AGENT_SUFFIX;
...
impl MessageProcessor {
    ...
    async fn handle_initialize(
        ...
        let server_info = Implementation::new("ontocode-mcp-server", env!("CARGO_PKG_VERSION"))
            .with_title("Codex");
    ...
    async fn handle_cancelled_notification(&self, params: rmcp::model::CancelledNotificationParam) {
        ...
        if let Err(e) = codex_arc
            .submit_with_id(Submission {
                ...
                op: ontocode_protocol::protocol::Op::Interrupt,
