...
pub(crate) struct ConfiguredHandler {
    pub event_name: ontocode_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            ontocode_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            ontocode_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            ontocode_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            ontocode_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            ontocode_protocol::protocol::HookEventName::PostCompact => "post-compact",
            ontocode_protocol::protocol::HookEventName::SessionStart => "session-start",
            ontocode_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            ontocode_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            ontocode_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            ontocode_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<ontocode_protocol::items::HookPromptFragment>,
    ) -> Vec<ontocode_protocol::items::HookPromptFragment> {
        self.output_spiller
