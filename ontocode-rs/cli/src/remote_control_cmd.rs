...
use anyhow::Context;
use clap::Args;
use ontocode_app_server::AppServerRuntimeOptions;
use ontocode_app_server::AppServerTransport;
use ontocode_app_server::AppServerWebsocketAuthSettings;
use ontocode_app_server_daemon::LifecycleCommand as AppServerLifecycleCommand;
use ontocode_app_server_daemon::LifecycleOutput as AppServerLifecycleOutput;
use ontocode_app_server_daemon::LifecycleStatus as AppServerLifecycleStatus;
use ontocode_app_server_daemon::RemoteControlReadyOutput as AppServerRemoteControlReadyOutput;
use ontocode_app_server_daemon::RemoteControlReadyStatus as AppServerRemoteControlReadyStatus;
use ontocode_app_server_daemon::RemoteControlStartOutput as AppServerRemoteControlStartOutput;
...
pub(crate) async fn run(
    ...
    match command.subcommand {
        ...
        Some(RemoteControlSubcommand::Start) => {
            ...
            let output = ontocode_app_server_daemon::ensure_remote_control_ready().await?;
        ...
        Some(RemoteControlSubcommand::Stop) => {
            ...
            let output = ontocode_app_server_daemon::run(AppServerLifecycleCommand::Stop).await?;
...
async fn run_foreground_remote_control(
    ...
    let mut app_server_task = tokio::spawn(ontocode_app_server::run_main_with_transport_options(
        arg0_paths,
...
async fn wait_for_foreground_remote_control_ready(
    ...
    ontocode_app_server_daemon::enable_remote_control_on_socket(
        socket_path.as_path(),
