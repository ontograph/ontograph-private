...
use ontocode_core_plugins::ConfiguredMarketplace;
use ontocode_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
...
use ontocode_core_plugins::installed_marketplaces::marketplace_install_root;
use ontocode_core_plugins::installed_marketplaces::resolve_configured_marketplace_root;
use ontocode_core_plugins::marketplace::MarketplaceListError;
use ontocode_core_plugins::marketplace::MarketplacePluginAuthPolicy;
...
use ontocode_plugin::validate_plugin_segment;
        ...
        for (index, marketplace) in marketplaces.into_iter().enumerate() {
            ...
            for plugin in &marketplace.plugins {
                ...
                let path = match &plugin.source {
                    ontocode_core_plugins::marketplace::MarketplacePluginSource::Local { path } => {
                        path.as_path().display().to_string()
                    }
                    ontocode_core_plugins::marketplace::MarketplacePluginSource::Git {
                        url,
                        path,
                        ref_name,
                        sha,
...
impl JsonPluginListOutput {
    fn from_marketplaces(
        marketplaces: Vec<ontocode_core_plugins::ConfiguredMarketplace>,
