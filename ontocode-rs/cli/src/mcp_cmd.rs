...
use ontocode_mcp::ResolvedMcpOAuthScopes;
...
use ontocode_protocol::protocol::McpAuthStatus;
use ontocode_rmcp_client::delete_oauth_tokens;
use ontocode_rmcp_client::perform_oauth_login;
...
async fn perform_oauth_login_retry_without_scopes(
    name: &str,
    url: &str,
    store_mode: ontocode_config::types::OAuthCredentialsStoreMode,
