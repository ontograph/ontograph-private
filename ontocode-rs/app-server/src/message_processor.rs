...
use ontocode_app_server_protocol::AuthMode as LoginAuthMode;
use ontocode_app_server_protocol::ChatgptAuthTokensRefreshParams;
...
use ontocode_app_server_protocol::experimental_required_message;
...
use ontocode_login::auth::ExternalAuth;
use ontocode_login::auth::ExternalAuthRefreshContext;
use ontocode_login::auth::ExternalAuthRefreshReason;
use ontocode_login::auth::ExternalAuthTokens;
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let thread_store =
            ontocode_core::thread_store_from_config(config.as_ref(), state_db.clone());
