...
use ontocode_app_server_protocol::AccountRateLimitsUpdatedNotification;
use ontocode_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use ontocode_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use ontocode_app_server_protocol::CommandAction as V2ParsedCommand;
use ontocode_app_server_protocol::CommandExecutionApprovalDecision;
use ontocode_app_server_protocol::CommandExecutionRequestApprovalParams;
use ontocode_app_server_protocol::CommandExecutionRequestApprovalResponse;
use ontocode_app_server_protocol::CommandExecutionSource;
use ontocode_app_server_protocol::CommandExecutionStatus;
use ontocode_app_server_protocol::DeprecationNoticeNotification;
use ontocode_app_server_protocol::DynamicToolCallParams;
use ontocode_app_server_protocol::DynamicToolCallStatus;
use ontocode_app_server_protocol::ErrorNotification;
use ontocode_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use ontocode_app_server_protocol::FileChangeApprovalDecision;
use ontocode_app_server_protocol::FileChangeRequestApprovalParams;
use ontocode_app_server_protocol::FileChangeRequestApprovalResponse;
use ontocode_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use ontocode_app_server_protocol::GuardianWarningNotification;
use ontocode_app_server_protocol::HookCompletedNotification;
use ontocode_app_server_protocol::HookStartedNotification;
use ontocode_app_server_protocol::ItemCompletedNotification;
use ontocode_app_server_protocol::ItemStartedNotification;
use ontocode_app_server_protocol::McpServerElicitationAction;
use ontocode_app_server_protocol::McpServerElicitationRequestParams;
use ontocode_app_server_protocol::McpServerElicitationRequestResponse;
use ontocode_app_server_protocol::McpServerStartupState;
use ontocode_app_server_protocol::McpServerStatusUpdatedNotification;
use ontocode_app_server_protocol::ModelReroutedNotification;
use ontocode_app_server_protocol::ModelVerificationNotification;
use ontocode_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use ontocode_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use ontocode_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use ontocode_app_server_protocol::PermissionsRequestApprovalParams;
use ontocode_app_server_protocol::PermissionsRequestApprovalResponse;
use ontocode_app_server_protocol::RawResponseItemCompletedNotification;
use ontocode_app_server_protocol::RequestId;
use ontocode_app_server_protocol::ServerNotification;
use ontocode_app_server_protocol::ServerRequestPayload;
use ontocode_app_server_protocol::ThreadGoalUpdatedNotification;
use ontocode_app_server_protocol::ThreadItem;
use ontocode_app_server_protocol::ThreadRealtimeClosedNotification;
use ontocode_app_server_protocol::ThreadRealtimeErrorNotification;
use ontocode_app_server_protocol::ThreadRealtimeItemAddedNotification;
use ontocode_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use ontocode_app_server_protocol::ThreadRealtimeSdpNotification;
use ontocode_app_server_protocol::ThreadRealtimeStartedNotification;
use ontocode_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use ontocode_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use ontocode_app_server_protocol::ThreadRollbackResponse;
use ontocode_app_server_protocol::ThreadSettingsUpdatedNotification;
use ontocode_app_server_protocol::ThreadStatus;
use ontocode_app_server_protocol::ThreadTokenUsage;
use ontocode_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use ontocode_app_server_protocol::ToolRequestUserInputOption;
use ontocode_app_server_protocol::ToolRequestUserInputParams;
use ontocode_app_server_protocol::ToolRequestUserInputQuestion;
use ontocode_app_server_protocol::ToolRequestUserInputResponse;
use ontocode_app_server_protocol::Turn;
use ontocode_app_server_protocol::TurnCompletedNotification;
use ontocode_app_server_protocol::TurnDiffUpdatedNotification;
...
use ontocode_app_server_protocol::TurnPlanStep;
use ontocode_app_server_protocol::TurnPlanUpdatedNotification;
use ontocode_app_server_protocol::TurnStartedNotification;
use ontocode_app_server_protocol::TurnStatus;
use ontocode_app_server_protocol::WarningNotification;
use ontocode_app_server_protocol::build_item_from_guardian_event;
use ontocode_app_server_protocol::guardian_auto_approval_review_notification;
use ontocode_app_server_protocol::item_event_to_server_notification;
use ontocode_core::CodexThread;
use ontocode_core::ThreadManager;
use ontocode_core::review_format::format_review_findings_block;
use ontocode_core::review_prompts;
use ontocode_protocol::ThreadId;
use ontocode_protocol::items::parse_hook_prompt_message;
use ontocode_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use ontocode_protocol::plan_tool::UpdatePlanArgs;
use ontocode_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use ontocode_protocol::protocol::Event;
use ontocode_protocol::protocol::EventMsg;
use ontocode_protocol::protocol::ExecApprovalRequestEvent;
use ontocode_protocol::protocol::Op;
use ontocode_protocol::protocol::RealtimeEvent;
use ontocode_protocol::protocol::ReviewDecision;
use ontocode_protocol::protocol::ReviewOutputEvent;
...
use ontocode_protocol::protocol::TurnDiffEvent;
use ontocode_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use ontocode_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use ontocode_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use ontocode_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use ontocode_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use ontocode_sandboxing::policy_transforms::intersect_permission_profiles;
use ontocode_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error) = match update.status {
                ontocode_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None)
                }
                ontocode_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None)
                }
                ontocode_protocol::protocol::McpStartupStatus::Failed { error } => {
                    (McpServerStartupState::Failed, Some(error))
                }
                ontocode_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status
                == ontocode_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                ontocode_protocol::protocol::GuardianAssessmentStatus::Denied
                | ontocode_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                ontocode_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                ontocode_protocol::protocol::GuardianAssessmentStatus::InProgress
                | ontocode_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: ontocode_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(
                ...
                ontocode_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: ontocode_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let ontocode_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(ontocode_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: ontocode_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: ontocode_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<CodexThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: ontocode_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            ontocode_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use ontocode_app_server_protocol::AutoReviewDecisionSource;
    use ontocode_app_server_protocol::GuardianApprovalReviewStatus;
    use ontocode_app_server_protocol::JSONRPCErrorError;
    use ontocode_app_server_protocol::TurnPlanStepStatus;
    use ontocode_login::CodexAuth;
    use ontocode_protocol::items::HookPromptFragment;
    use ontocode_protocol::items::build_hook_prompt_message;
    use ontocode_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use ontocode_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use ontocode_protocol::plan_tool::PlanItemArg;
    use ontocode_protocol::plan_tool::StepStatus;
    use ontocode_protocol::protocol::AgentMessageEvent;
    use ontocode_protocol::protocol::AskForApproval;
    use ontocode_protocol::protocol::CreditsSnapshot;
    use ontocode_protocol::protocol::EventMsg;
    use ontocode_protocol::protocol::GuardianAssessmentEvent;
    use ontocode_protocol::protocol::GuardianAssessmentStatus;
    ...
    use ontocode_thread_store::StoredThreadHistory;
    use ontocode_utils_absolute_path::AbsolutePathBuf;
    use ontocode_utils_absolute_path::test_support::PathBufExt;
    use ontocode_utils_absolute_path::test_support::test_path_buf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: ontocode_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(ontocode_protocol::protocol::GuardianRiskLevel::Low),
                Some(ontocode_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(ontocode_protocol::protocol::GuardianRiskLevel::High),
                Some(ontocode_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(ontocode_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = ontocode_protocol::protocol::GuardianAssessmentAction::Command {
            source: ontocode_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: ontocode_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: ontocode_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(ontocode_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(
                    ontocode_protocol::protocol::GuardianUserAuthorization::Low,
                ),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    ontocode_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(ontocode_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(ontocode_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = ontocode_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: ontocode_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: ontocode_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            ontocode_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let thread_manager = Arc::new(
            ontocode_core::test_support::thread_manager_with_models_provider_and_home(
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(ontocode_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(ontocode_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(ontocode_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            ontocode_app_server_protocol::HookPromptFragment {
