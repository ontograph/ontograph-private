...
fn init_test_tracing() -> &'static TestTracing {
    ...
    TEST_TRACING.get_or_init(|| {
        ...
        let provider = SdkTracerProvider::builder()
            ...
            .build();
        let tracer = provider.tracer("ontocode-app-server-message-processor-tests");
...
async fn build_test_processor(
    ...
    let config_manager = ConfigManager::new(
        ...
        Arc::new(ontocode_config::NoopThreadConfigLoader),
    );
    ...
    loop {
        ...
        match envelope {
            crate::outgoing_message::OutgoingEnvelope::ToConnection {
                ...
                if matches!(
                    notification,
                    ontocode_app_server_protocol::ServerNotification::ThreadStarted(_)
                ) {
                    return;
                }
            }
