...
use ontocode_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: ontocode_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<ontocode_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
