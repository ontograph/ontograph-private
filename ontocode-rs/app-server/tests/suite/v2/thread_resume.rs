...
use ontocode_login::REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR;
...
use ontocode_protocol::protocol::SessionSource as RolloutSessionSource;
...
use ontocode_rollout::append_rollout_item_to_path;
use ontocode_rollout::read_session_meta_line;
...
async fn thread_goal_clear_deletes_goal_and_notifies() -> Result<()> {
    ...
    .await??;
    let get: ontocode_app_server_protocol::ThreadGoalGetResponse = to_response(get_resp)?;
...
"#;
    ...
    let expected_file_change = ThreadItem::FileChange {
        ...
        changes: vec![ontocode_app_server_protocol::FileUpdateChange {
