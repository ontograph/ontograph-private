...
use ontocode_app_server_protocol::PluginAuthPolicy;
        ...
        PluginShareListResponse {
            data: vec![PluginShareListItem {
                plugin: PluginSummary {
                    ...
                    availability: ontocode_app_server_protocol::PluginAvailability::Available,
    ...
    let request_id = mcp
        .send_plugin_list_request(PluginListParams {
            ...
            marketplace_kinds: Some(vec![
                ontocode_app_server_protocol::PluginListMarketplaceKind::Local,
            ]),
        })
        .await?;
    let response: JSONRPCResponse = timeout(
...
async fn plugin_share_update_targets_updates_share_targets() -> Result<()> {
    ...
    assert_eq!(
        ...
        PluginShareUpdateTargetsResponse {
            ...
            discoverability: ontocode_app_server_protocol::PluginShareDiscoverability::Unlisted,
        }
    );
    Ok(())
}
