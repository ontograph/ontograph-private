...
use ontocode_core::config::set_project_trust_level;
        ...
        vec![PluginMarketplaceEntry {
            ...
            plugins: vec![
                PluginSummary {
                    ...
                    auth_policy: PluginAuthPolicy::OnInstall,
                    availability: ontocode_app_server_protocol::PluginAvailability::Available,
                    interface: Some(ontocode_app_server_protocol::PluginInterface {
...
async fn plugin_list_includes_remote_marketplaces_when_remote_plugin_enabled() -> Result<()> {
  ...
  "pagination": {
    ...
    assert_eq!(
        ...
        ontocode_app_server_protocol::PluginAvailability::Available
    );
    assert_eq!(
...
async fn plugin_list_marks_remote_plugin_disabled_by_admin() -> Result<()> {
  ...
  "pagination": {
    ...
    assert_eq!(
        plugin.availability,
        ontocode_app_server_protocol::PluginAvailability::DisabledByAdmin
    );
    Ok(())
}
