...
use ontocode_app_server_protocol::Model;
use ontocode_app_server_protocol::ModelListParams;
use ontocode_app_server_protocol::ModelListResponse;
use ontocode_app_server_protocol::ModelServiceTier;
use ontocode_app_server_protocol::ModelUpgradeInfo;
use ontocode_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        ontocode_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
