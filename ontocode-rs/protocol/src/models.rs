...
use ontocode_utils_image::PromptImageMode;
use ontocode_utils_image::load_for_prompt_bytes;
...
use ontocode_utils_image::ImageProcessingError;
        ...
        for i in 0..200 {
            exec_policy
                .add_prefix_rule(
                    ...
                    ontocode_execpolicy::Decision::Allow,
                )
                .expect("add rule");
        }
