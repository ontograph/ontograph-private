...
use ontocode_protocol::config_types::WebSearchToolConfig;
...
pub use ontocode_protocol::protocol::RealtimeConversationVersion as RealtimeWsVersion;
pub use ontocode_protocol::protocol::RealtimeVoice;
