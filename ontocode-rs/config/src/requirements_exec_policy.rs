...
use ontocode_execpolicy::rule::PatternToken;
use ontocode_execpolicy::rule::PrefixPattern;
use ontocode_execpolicy::rule::PrefixRule;
...
impl RequirementsExecPolicyToml {
    ...
    /// representation used by `ontocode-execpolicy`.
