...
use ontocode_config::PluginConfigEdit;
use ontocode_config::apply_user_plugin_config_edits;
use ontocode_config::clear_user_plugin;
use ontocode_config::set_user_plugin_enabled;
use ontocode_config::types::PluginConfig;
use ontocode_config::version_for_toml;
use ontocode_core_skills::SkillMetadata;
use ontocode_hooks::plugin_hook_declarations;
...
use ontocode_plugin::prompt_safe_plugin_description;
...
impl PluginsManager {
    ...
    pub async fn read_plugin_detail_for_marketplace_plugin(
        ...
        let resolved_skills = load_plugin_skills(
            ...
            &manifest.paths,
            self.restriction_product,
            &ontocode_core_skills::config_rules::skill_config_rules_from_stack(
                &config.config_layer_stack,
            ),
        )
        .await;
