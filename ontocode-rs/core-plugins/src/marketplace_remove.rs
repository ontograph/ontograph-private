...
use ontocode_config::RemoveMarketplaceConfigOutcome;
use ontocode_config::remove_user_marketplace_config;
...
mod tests {
    use super::*;
    use ontocode_config::MarketplaceConfigUpdate;
    use ontocode_config::record_user_marketplace;
    ...
    fn remove_marketplace_sync_removes_config_and_installed_root() {
        ...
        let config =
            fs::read_to_string(codex_home.path().join(ontocode_config::CONFIG_TOML_FILE)).unwrap();
