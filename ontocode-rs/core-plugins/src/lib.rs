...
pub type LoadedPlugin = ontocode_plugin::LoadedPlugin<ontocode_config::McpServerConfig>;
pub type PluginLoadOutcome = ontocode_plugin::PluginLoadOutcome<ontocode_config::McpServerConfig>;
