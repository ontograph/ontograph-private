...
use ontocode_config::AppToolApproval;
...
use ontocode_config::McpServerOAuthConfig;
use ontocode_config::McpServerToolConfig;
...
fn remote_installed_plugin(name: &str) -> RemoteInstalledPlugin {
    RemoteInstalledPlugin {
        ...
        name: name.to_string(),
        enabled: true,
        install_policy: ontocode_app_server_protocol::PluginInstallPolicy::Available,
        auth_policy: ontocode_app_server_protocol::PluginAuthPolicy::OnUse,
...
async fn build_remote_installed_plugin_marketplaces_from_cache_uses_remote_metadata() {
    ...
    plugin.install_policy = ontocode_app_server_protocol::PluginInstallPolicy::InstalledByDefault;
    plugin.auth_policy = ontocode_app_server_protocol::PluginAuthPolicy::OnInstall;
    plugin.interface = Some(ontocode_app_server_protocol::PluginInterface {
    ...
    assert_eq!(
        ...
        ontocode_app_server_protocol::PluginInstallPolicy::InstalledByDefault
    );
    assert_eq!(
        plugin.auth_policy,
        ontocode_app_server_protocol::PluginAuthPolicy::OnInstall
    );
