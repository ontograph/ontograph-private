...
pub use ontocode_utils_string::sanitize_metric_tag_value;
...
impl From<ontocode_app_server_protocol::AuthMode> for TelemetryAuthMode {
    fn from(mode: ontocode_app_server_protocol::AuthMode) -> Self {
        match mode {
            ontocode_app_server_protocol::AuthMode::ApiKey => Self::ApiKey,
            ontocode_app_server_protocol::AuthMode::Chatgpt
            | ontocode_app_server_protocol::AuthMode::ChatgptAuthTokens
            | ontocode_app_server_protocol::AuthMode::AgentIdentity => Self::Chatgpt,
        }
    }
}
