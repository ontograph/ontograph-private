pub(crate) const OTEL_TARGET_PREFIX: &str = "ontocode_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "ontocode_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "ontocode_otel.trace_safe";
