use ontocode_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use ontocode_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use ontocode_protocol::config_types::CollaborationModeMask;
use ontocode_protocol::config_types::ModeKind;
use ontocode_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
