...
use ontocode_client::with_chatgpt_cloudflare_cookie_store;
...
use ontocode_protocol::protocol::RateLimitReachedType;
use ontocode_protocol::protocol::RateLimitSnapshot;
use ontocode_protocol::protocol::RateLimitWindow;
use ontocode_protocol::protocol::SpendControlLimitSnapshot;
...
impl Client {
    pub fn new(base_url: impl Into<String>) -> Result<Self> {
        ...
        Ok(Self {
            base_url,
            http,
            auth_provider: ontocode_model_provider::unauthenticated_auth_provider(),
            user_agent: None,
    ...
    pub fn from_auth(base_url: impl Into<String>, auth: &CodexAuth) -> Result<Self> {
        Ok(Self::new(base_url)?
            ...
            .with_auth_provider(ontocode_model_provider::auth_provider_from_auth(auth)))
    }
...
mod tests {
    use super::*;
    use ontocode_backend_openapi_models::models::AdditionalRateLimitDetails;
    use ontocode_backend_openapi_models::models::RateLimitReachedKind;
    use ontocode_backend_openapi_models::models::RateLimitReachedType as BackendRateLimitReachedType;
    ...
    fn usage_payload_maps_primary_and_additional_rate_limits() {
        let payload = RateLimitStatusPayload {
            ...
            spend_control: Some(Some(Box::new(
                ontocode_backend_openapi_models::models::SpendControlStatusDetails {
                    reached: false,
