...
`ontocode-tools` is the shared support crate for building, adapting, and executing
...
1. Keep extension-owned executable-tool authoring in `ontocode-extension-api`.
