...
impl BearerAuthProvider {
    ...
    pub fn from_provider_oauth_credential(credential: &ProviderOAuthCredential) -> Self {
        Self {
            token: Some(credential.access_token.clone()),
...
mod tests {
    ...
    fn bearer_auth_provider_reports_when_auth_header_will_attach() {
        ...
        assert_eq!(
            ontocode_api::auth_header_telemetry(&auth),
            ontocode_api::AuthHeaderTelemetry {
                attached: true,
