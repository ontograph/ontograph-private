//! Helpers for truncating tool and exec output using [`TruncationPolicy`](ontocode_protocol::protocol::TruncationPolicy).

use ontocode_protocol::models::FunctionCallOutputContentItem;
pub use ontocode_utils_string::approx_bytes_for_tokens;
pub use ontocode_utils_string::approx_token_count;
pub use ontocode_utils_string::approx_tokens_from_byte_count;
use ontocode_utils_string::truncate_middle_chars;
use ontocode_utils_string::truncate_middle_with_token_budget;

pub use ontocode_protocol::protocol::TruncationPolicy;
