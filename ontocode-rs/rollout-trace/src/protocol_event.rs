...
use ontocode_protocol::protocol::ExecCommandStatus;
...
use ontocode_protocol::protocol::PatchApplyStatus;
...
pub(crate) enum ToolRuntimePayload<'a> {
    ...
    CollabAgentSpawnBegin(&'a ontocode_protocol::protocol::CollabAgentSpawnBeginEvent),
    CollabAgentSpawnEnd(&'a ontocode_protocol::protocol::CollabAgentSpawnEndEvent),
    CollabAgentInteractionBegin(&'a ontocode_protocol::protocol::CollabAgentInteractionBeginEvent),
    CollabAgentInteractionEnd(&'a ontocode_protocol::protocol::CollabAgentInteractionEndEvent),
    CollabWaitingBegin(&'a ontocode_protocol::protocol::CollabWaitingBeginEvent),
    CollabWaitingEnd(&'a ontocode_protocol::protocol::CollabWaitingEndEvent),
    CollabCloseBegin(&'a ontocode_protocol::protocol::CollabCloseBeginEvent),
    CollabCloseEnd(&'a ontocode_protocol::protocol::CollabCloseEndEvent),
}
