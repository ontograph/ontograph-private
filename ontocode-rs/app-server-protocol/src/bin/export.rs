...
fn main() -> Result<()> {
    ...
    ontocode_app_server_protocol::generate_ts_with_options(
        ...
        ontocode_app_server_protocol::GenerateTsOptions {
            experimental_api: args.experimental,
            ..ontocode_app_server_protocol::GenerateTsOptions::default()
        },
    )?;
    ontocode_app_server_protocol::generate_json_with_experimental(&args.out_dir, args.experimental)
}
