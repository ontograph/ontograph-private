...
use ontocode_protocol::protocol::AgentReasoningEvent;
use ontocode_protocol::protocol::AgentReasoningRawContentEvent;
...
use ontocode_protocol::protocol::ContextCompactedEvent;
use ontocode_protocol::protocol::DynamicToolCallResponseEvent;
use ontocode_protocol::protocol::ErrorEvent;
use ontocode_protocol::protocol::EventMsg;
use ontocode_protocol::protocol::ExecCommandBeginEvent;
use ontocode_protocol::protocol::ExecCommandEndEvent;
use ontocode_protocol::protocol::GuardianAssessmentEvent;
use ontocode_protocol::protocol::GuardianAssessmentStatus;
use ontocode_protocol::protocol::ImageGenerationBeginEvent;
use ontocode_protocol::protocol::ImageGenerationEndEvent;
use ontocode_protocol::protocol::ItemCompletedEvent;
use ontocode_protocol::protocol::ItemStartedEvent;
use ontocode_protocol::protocol::McpToolCallBeginEvent;
use ontocode_protocol::protocol::McpToolCallEndEvent;
use ontocode_protocol::protocol::PatchApplyBeginEvent;
use ontocode_protocol::protocol::PatchApplyEndEvent;
...
use ontocode_protocol::protocol::ViewImageToolCallEvent;
use ontocode_protocol::protocol::WebSearchBeginEvent;
use ontocode_protocol::protocol::WebSearchEndEvent;
...
#[cfg(test)]
use ontocode_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use ontocode_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `ontocode-rs/core/rollout/policy.rs`.
    ...
    fn handle_response_item(&mut self, item: &ontocode_protocol::models::ResponseItem) {
    ...
    fn handle_item_started(&mut self, payload: &ItemStartedEvent) {
        match &payload.item {
            ontocode_protocol::items::TurnItem::Plan(plan) => {
            ...
            ontocode_protocol::items::TurnItem::UserMessage(_)
            | ontocode_protocol::items::TurnItem::HookPrompt(_)
            | ontocode_protocol::items::TurnItem::AgentMessage(_)
            | ontocode_protocol::items::TurnItem::Reasoning(_)
            | ontocode_protocol::items::TurnItem::WebSearch(_)
            | ontocode_protocol::items::TurnItem::ImageView(_)
            | ontocode_protocol::items::TurnItem::ImageGeneration(_)
            | ontocode_protocol::items::TurnItem::FileChange(_)
            | ontocode_protocol::items::TurnItem::McpToolCall(_)
            | ontocode_protocol::items::TurnItem::ContextCompaction(_) => {}
        }
    }
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &ontocode_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_close_end(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabCloseEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &ontocode_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(&mut self, payload: &ontocode_protocol::protocol::ReviewRequest) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &ontocode_protocol::protocol::ExitedReviewModeEvent,
    ) {
        let review = payload
            .review_output
            .as_ref()
...
fn convert_dynamic_tool_content_items(
    items: &[ontocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            ontocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText {
                text,
            } => DynamicToolCallOutputContentItem::InputText { text },
            ontocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
...
mod tests {
    ...
    use ontocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use ontocode_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use ontocode_protocol::items::TurnItem as CoreTurnItem;
    use ontocode_protocol::items::UserMessageItem as CoreUserMessageItem;
    ...
    use ontocode_protocol::models::MessagePhase as CoreMessagePhase;
    use ontocode_protocol::models::WebSearchAction as CoreWebSearchAction;
    use ontocode_protocol::parse_command::ParsedCommand;
    ...
    use ontocode_protocol::protocol::DynamicToolCallResponseEvent;
    use ontocode_protocol::protocol::ExecCommandEndEvent;
    use ontocode_protocol::protocol::ExecCommandSource;
    use ontocode_protocol::protocol::ItemStartedEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![ontocode_protocol::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                ontocode_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    ontocode_protocol::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(ontocode_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(ontocode_protocol::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: ontocode_protocol::openai_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(ontocode_protocol::openai_models::ReasoningEffort::Medium),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                ontocode_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                ontocode_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(ontocode_protocol::models::ResponseItem::Message {
                id: Some("msg-1".into()),
                role: "user".into(),
                content: vec![ontocode_protocol::models::ContentItem::InputText {
