...
use ontocode_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use ontocode_protocol::openai_models::ReasoningEffort;
use ontocode_protocol::openai_models::default_input_modalities;
use ontocode_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use ontocode_protocol::protocol::ModelVerification as CoreModelVerification;
