use super::*;
use ontocode_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use ontocode_protocol::items::AgentMessageContent;
use ontocode_protocol::items::AgentMessageItem;
use ontocode_protocol::items::FileChangeItem;
use ontocode_protocol::items::ImageViewItem;
use ontocode_protocol::items::McpToolCallItem;
use ontocode_protocol::items::McpToolCallStatus as CoreMcpToolCallStatus;
use ontocode_protocol::items::ReasoningItem;
use ontocode_protocol::items::TurnItem;
use ontocode_protocol::items::UserMessageItem;
use ontocode_protocol::items::WebSearchItem;
use ontocode_protocol::mcp::CallToolResult;
use ontocode_protocol::mcp::McpServerInfo;
use ontocode_protocol::memory_citation::MemoryCitation as CoreMemoryCitation;
use ontocode_protocol::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
...
use ontocode_protocol::permissions::FileSystemAccessMode as CoreFileSystemAccessMode;
use ontocode_protocol::permissions::FileSystemPath as CoreFileSystemPath;
use ontocode_protocol::permissions::FileSystemSandboxEntry as CoreFileSystemSandboxEntry;
use ontocode_protocol::permissions::FileSystemSpecialPath as CoreFileSystemSpecialPath;
use ontocode_protocol::protocol::AgentStatus as CoreAgentStatus;
use ontocode_protocol::protocol::AskForApproval as CoreAskForApproval;
use ontocode_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use ontocode_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use ontocode_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use ontocode_protocol::user_input::UserInput as CoreUserInput;
...
fn core_turn_item_into_thread_item_converts_supported_variants() {
    ...
    let file_change_item = TurnItem::FileChange(FileChangeItem {
        ...
        .into_iter()
        .collect(),
        status: Some(ontocode_protocol::protocol::PatchApplyStatus::Completed),
        auto_approved: None,
...
fn thread_settings_update_params_preserve_field_level_experimental_gates() {
    ...
    let collaboration_mode = ThreadSettingsUpdateParams {
        ...
        collaboration_mode: Some(ontocode_protocol::config_types::CollaborationMode {
            mode: ontocode_protocol::config_types::ModeKind::Plan,
