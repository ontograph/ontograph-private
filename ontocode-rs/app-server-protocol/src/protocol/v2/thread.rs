...
use ontocode_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use ontocode_protocol::protocol::TokenUsage as CoreTokenUsage;
use ontocode_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
impl From<ontocode_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: ontocode_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> ontocode_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => ontocode_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => ontocode_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `ontocode_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
