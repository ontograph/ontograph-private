...
use ontocode_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use ontocode_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use ontocode_protocol::user_input::ByteRange as CoreByteRange;
use ontocode_protocol::user_input::TextElement as CoreTextElement;
