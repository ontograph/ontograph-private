...
use ontocode_protocol::protocol::HookEventName as CoreHookEventName;
use ontocode_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use ontocode_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use ontocode_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use ontocode_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use ontocode_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use ontocode_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use ontocode_protocol::protocol::HookScope as CoreHookScope;
use ontocode_protocol::protocol::HookSource as CoreHookSource;
use ontocode_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
