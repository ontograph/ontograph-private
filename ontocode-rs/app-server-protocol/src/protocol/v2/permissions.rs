...
use ontocode_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use ontocode_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use ontocode_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use ontocode_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use ontocode_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use ontocode_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> ontocode_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<ontocode_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: ontocode_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            ontocode_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            ontocode_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            ontocode_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
