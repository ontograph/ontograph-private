...
use ontocode_protocol::items::McpToolCallError as CoreMcpToolCallError;
use ontocode_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use ontocode_protocol::mcp::McpServerInfo;
use ontocode_protocol::mcp::Resource as McpResource;
pub use ontocode_protocol::mcp::ResourceContent as McpResourceContent;
use ontocode_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use ontocode_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from ontocode_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> ontocode_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => ontocode_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => ontocode_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => ontocode_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
