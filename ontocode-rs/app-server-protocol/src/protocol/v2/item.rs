...
use ontocode_experimental_api_macros::ExperimentalApi;
use ontocode_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use ontocode_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use ontocode_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use ontocode_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use ontocode_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use ontocode_protocol::protocol::AgentStatus as CoreAgentStatus;
use ontocode_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use ontocode_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use ontocode_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use ontocode_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use ontocode_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use ontocode_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<ontocode_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: ontocode_protocol::models::WebSearchAction) -> Self {
        match value {
            ontocode_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            ontocode_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            ontocode_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            ontocode_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<ontocode_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: ontocode_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for ontocode_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
