...
use ontocode_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use ontocode_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use ontocode_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use ontocode_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use ontocode_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum LoginAccountResponse {
    ...
    #[serde(rename = "gemini", rename_all = "camelCase")]
    #[ts(rename = "gemini", rename_all = "camelCase")]
    Gemini {
        // Use plain String for identifiers to avoid TS/JSON Schema quirks around uuid-specific types.
        // Convert to/from UUIDs at the application layer as needed.
        login_id: String,
