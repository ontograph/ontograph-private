...
use ontocode_extension_api::ThreadIdleInput;
...
use ontocode_extension_api::TokenUsageContributor;
...
use ontocode_extension_api::ToolLifecycleContributor;
use ontocode_extension_api::ToolLifecycleFuture;
use ontocode_extension_api::TurnAbortInput;
use ontocode_extension_api::TurnErrorInput;
use ontocode_extension_api::TurnLifecycleContributor;
    ...
    C: Send + Sync + 'static,
{
    async fn on_turn_start(&self, input: TurnStartInput<'_>) {
        ...
        if matches!(
            input.collaboration_mode.mode,
            ontocode_protocol::config_types::ModeKind::Plan
        ) {
