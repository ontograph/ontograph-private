...
use ontocode_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
use ontocode_protocol::protocol::SessionSource;
use ontocode_protocol::user_input::UserInput;
use ontocode_skills_extension::SkillProviders;
use ontocode_skills_extension::catalog::SkillAuthority;
use ontocode_skills_extension::catalog::SkillCatalog;
use ontocode_skills_extension::catalog::SkillCatalogEntry;
use ontocode_skills_extension::catalog::SkillPackageId;
use ontocode_skills_extension::catalog::SkillReadResult;
use ontocode_skills_extension::catalog::SkillResourceId;
use ontocode_skills_extension::catalog::SkillSearchResult;
use ontocode_skills_extension::catalog::SkillSourceKind;
use ontocode_skills_extension::install_with_providers;
use ontocode_skills_extension::provider::SkillListQuery;
use ontocode_skills_extension::provider::SkillProvider;
use ontocode_skills_extension::provider::SkillProviderFuture;
use ontocode_skills_extension::provider::SkillReadRequest;
use ontocode_skills_extension::provider::SkillSearchRequest;
